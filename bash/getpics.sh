...
#my additions
rm -rf ~/public_html/pics2
mkdir -p ~/public_html/pics2 || (echo "Failed to create a pics2" && exit 1)
wget -q -O ~/public_html/pics2/pics.tgz https://zonzorp.net/pics.tgz && tar -xz -C ~/public_html/pics2 -f ~/public_html/pics2/pics.tgz && rm ~/public_html/pics2/pics.tgz
...
#my additions 2
test -d ~/public_html/pics2 && cat <<BLOO
Found $(find ~/public_html/pics2 -type f|wc -l) files in the public_html/pics2 directory.
The public_html/pics2 directory uses $(du -sh ~/public_html/pics2|awk '{print $1}') space on the disk.
BLOO
